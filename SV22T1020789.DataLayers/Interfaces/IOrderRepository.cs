...
namespace SV22T1020789.DataLayers.Interfaces
{
    /// <summary>
    ...
    public interface IOrderRepository
    {
        ...
        /// <summary>
        /// Cập nhật trạng thái của đơn hàng và các thông tin liên quan (Shipper, ngày hoàn tất...)
        /// </summary>
        /// <param name="orderID">Mã đơn hàng</param>
        /// <param name="status">Trạng thái mới (theo Enum)</param>
        /// <param name="shipperID">Mã người giao hàng (nếu có)</param>
        /// <param name="deliveryDate">Ngày giao hàng (nếu có)</param>
        /// <param name="finishedDate">Ngày hoàn tất (nếu có)</param>
        /// <returns></returns>
        Task<bool> UpdateStatusAsync(int orderID, OrderStatusEnum status, int? shipperID = null, DateTime? deliveryDate = null, DateTime? finishedDate = null);
